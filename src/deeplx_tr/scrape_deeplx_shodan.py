...
from deeplx_tr.check_deeplx import check_deeplx_async
from deeplx_tr.scrape_deeplx_fofa import scrape_deeplx_fofa

cache = dc.Cache(Path.home() / ".diskcache" / "deeplx-sites")
